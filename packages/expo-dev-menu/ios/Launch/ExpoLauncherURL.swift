...
/**
 ...
 Keep in sync with `packages/expo-dev-menu/android/src/main/java/expo/modules/devmenu/launch/ExpoLauncherUrl.kt`.
 */
public struct ExpoLauncherURL {
  ...
  public enum Param: String {
    ...
    public var name: String {
      return ExpoLauncherURL.reservedPrefix + rawValue
    }
  }
