...
internal class TaskManagerUnavailable: Exception, @unchecked Sendable {
  override var reason: String {
    "'expo-task-manager' module is required to use background services"
  }
}

internal final class LocationAuthorizationDenied: Exception, @unchecked Sendable {
  override var reason: String {
...
internal final class LocationAuthorizationRestricted: Exception, @unchecked Sendable {
  override var reason: String {
...
internal final class LocationServiceSessionRequired: Exception, @unchecked Sendable {
  override var reason: String {
...
internal final class LocationUpdatesEndedUnexpectedly: Exception, @unchecked Sendable {
  override var reason: String {
...
internal final class SignificantLocationChangesUnavailable: Exception, @unchecked Sendable {
  override var reason: String {
...
internal final class MissingLocationBackgroundMode: Exception, @unchecked Sendable {
  override var reason: String {
